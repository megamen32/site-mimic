...
#
# Run probes inside:
#   ip netns exec mimic-win ./examples/.../stand-probe https://fp.example.test/fp
#
...
up)
    ...
    grep -q "fp.example.test" /etc/hosts || \
        echo "203.0.113.10 fp.example.test  # your /fp receiver" >> /etc/hosts

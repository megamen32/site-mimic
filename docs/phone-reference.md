...
python3 tools/ja4_from_pcap.py \
  ./captures/vk-site-mimic/browser.pcap \
  ./captures/vk-site-mimic/probe.pcap
```
...
## Windows 11 23H2 (LAN reference machine)
...
receiver `https://fp.example.test/` (Chrome mapped it to our nginx via
